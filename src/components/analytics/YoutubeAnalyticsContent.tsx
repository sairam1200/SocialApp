...
import { Users, ThumbsUp, MessageCircle, DollarSign, Clock, TrendingUp, Monitor, MapPin, Play } from "lucide-react";
          ...
          return (
            <div key={key} className="flex items-center justify-between">
              ...
              <div className="text-right ml-4 shrink-0">
                <p className="text-sm font-semibold text-foreground">{formatCompactNumber(val)}</p>
