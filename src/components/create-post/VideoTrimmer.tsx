	...
	return (
		<div className="flex flex-col gap-3">
			<div className="flex items-center gap-4 w-full">
				<div
					ref={containerRef}
					className="relative h-14 flex-1 rounded-lg overflow-hidden bg-muted flex items-center border border-border"
				>
				...
				<div className="flex gap-2">
					<button
						onClick={onRevert}
						className="px-4 py-2 text-xs font-bold bg-muted rounded-md text-muted-foreground hover:bg-muted/80 transition-colors cursor-pointer"
					>
						Revert
					</button>
					<button
