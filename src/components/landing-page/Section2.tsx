...
export default function Section2() {
	return (
		<div className="w-full bg-accent text-accent-foreground relative">
			{/* Company Carousel */}
			<div
				className="w-full py-4 lg:py-6 bg-accent/70 z-10"
				style={{ boxShadow: "0px 4px 8px 0px color-mix(in srgb, var(--primary) 24%, transparent)" }}
			>
				<Carousel
					opts={{ loop: true }}
					plugins={[
			...
			{/* DISCOVERY SECTION */}
			<div className="relative overflow-hidden bg-secondary text-secondary-foreground py-12 md:py-32">
				<h2 className="mb-8 text-balance text-center text-xl font-bold tracking-tight text-secondary-foreground md:text-2xl">Universal Unified Discovery</h2>
							...
							{DiscoveryImages.map((img, i) => (
								<CarouselItem key={i} className="basis-3/4">
									<div
										...
										style={{ boxShadow: "0px 4px 4px 0px color-mix(in srgb, var(--primary) 22%, transparent)" }}
									>
										{typeof img === "string" ? (
											<Image
												src={`/images/${img}`}
				...
				<div className="hidden md:grid grid-cols-4 gap-4 max-w-6xl px-4 mx-auto z-10">
					{/* Column 1 — first 2 images are above-the-fold */}
					...
					{/* Column 2 — 3rd image above-the-fold, rest lazy */}
					<div className="flex flex-col gap-4 h-full">
						<Image
					...
					{/* Column 3 — all below-the-fold, lazy */}
					<div className="flex flex-col gap-4 h-full">
						<Image
					...
					{/* Column 4 — all below-the-fold, lazy */}
					<div className="flex flex-col gap-4 h-full">
