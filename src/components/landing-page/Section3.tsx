		...
		>
          ...
          bg-repeat bg-top opacity-[0.05]"
			...
			<div className="relative max-w-7xl w-full flex flex-col md:flex-row md:justify-between items-center gap-10">
				<div className="flex flex-col md:w-1/2 text-left text-primary-foreground order-1 md:order-1">
					<h2 className="mb-5 text-balance text-xl font-bold leading-tight tracking-tight md:text-2xl">One Username for all your profiles.</h2>
