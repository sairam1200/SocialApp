...
export function AddAccountDialog({ open, onClose, platforms: availablePlatforms, onSelect }: AddAccountDialogProps) {
	...
	const isImportAvailable =
		...
		selectedPlatformConfig.capabilities.importContent &&
			...
			footer={
				<div className="flex justify-end gap-4">
					...
					<Button
						...
						disabled={!selectedPlatformId || (selectedType === "connect" && !isImportAvailable)}
					/>
				</div>
			}
		>
				...
				<div className="flex flex-col gap-2">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-1">
						...
						<TypeOptionCard
							...
							onClick={() => isImportAvailable && setSelectedType("connect")}
