...
const AuthFooter = () => {
  return (
    <footer className='border-t-[1px] border-primary/25 w-full mt-auto mb-[50px] pt-[16px] px-8'>
      <div className='w-full flex flex-col items-center md:flex-row md:items-center md:justify-between gap-[12px]'>
        ...
        <div className='flex flex-col items-center md:items-start'>
          <div className='flex flex-col items-center md:flex-row md:items-center gap-[12px] mt-5'>
            ...
            <p className='font-opensans text-[12px] text-foreground leading-[14.4px] mt-1 md:mt-0 text-center md:text-left'>Your social media, unified.</p>
          </div>
          <p className='font-opensans text-[12px] text-foreground leading-[14.4px] mt-[12px] text-center md:text-left'>2025 Gaddr Search & Me. All rights reserved.</p>
        </div>
        {/* Center: links */}
        <div className='flex justify-center gap-8 md:gap-10'>
          <Link href="/contact" className='font-opensans font-bold text-[12px] text-foreground leading-[16px] transition-colors hover:text-primary'>Help Center</Link>
          <Link href="/contact" className='font-opensans font-bold text-[12px] text-foreground leading-[16px] transition-colors hover:text-primary'>Contact Us</Link>
          <Link href="/privacy-policy" className='font-opensans font-bold text-[12px] text-foreground leading-[16px] transition-colors hover:text-primary'>Privacy policy</Link>
          <Link href="/terms" className='font-opensans font-bold text-[12px] text-foreground leading-[16px] transition-colors hover:text-primary'>Terms & conditions</Link>
        </div>
        {/* Right: social icons */}
        <div className='w-full md:w-auto flex items-center justify-center md:justify-end gap-[14px] mt-1'>
          <button type="button" aria-label="Continue with Gaddr" className='p-[8px] bg-gradient-to-r from-gradient-from to-gradient-to w-[40px] h-[40px] rounded-full border border-primary-light transition-colors flex items-center justify-center shadow-[0px_2px_4px_rgba(97,54,255,0.15)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary'>
