									...
									<div className="flex items-start justify-between gap-4 py-4">
										...
										{(closeOnOverlayClick || closeOnEsc) && (
											<button
												...
												className="shrink-0 rounded-full text-muted-foreground hover:bg-muted hover:text-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-ring cursor-pointer"
											>
