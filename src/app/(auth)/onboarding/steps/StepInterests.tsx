...
export function StepTwoInterests({
	...
	return (
		<div className="animate-in fade-in slide-in-from-bottom-4 duration-500 bg-white p-8 rounded-4xl border border-indigo-100 shadow-lg flex flex-col h-[750px] w-full max-w-3xl mx-auto">
			...
			<div className="flex items-center gap-4 mt-4 pt-4 border-t border-gray-100">
				...
				<button
					...
					className={cn(
						...
						canProceed
							? "bg-[#6e08b8] text-white hover:bg-[#5a0699]"
