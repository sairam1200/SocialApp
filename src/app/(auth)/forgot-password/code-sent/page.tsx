...
export default function CodeSentPage() {
  ...
  const renderMessageButton = () => (
    <Button
      ...
      className={`bg-none text-primary text-xs font-bold underline-offset-0 shadow-none py-0 px-0 ${isResendLoading
        ? "no-underline text-primary shadow-none text-xs relative top-1 left-[-9] py-0 px-0 disabled:opacity-70"
        : ""
        }`}
  ...
  return (
    <div className="max-w-[359px] mx-auto py-6 max-md:px-6">
      ...
      <div className="text-center text-base text-muted-foreground max-md:text-sm">
        <p>We have sent a verification code to your email that you can use to reset your password</p>
        <button
          type="button"
          onClick={() => router.push("/forgot-password")}
          className=" mt-2 inline-flex items-center gap-1.5 rounded-lg border border-primary-light px-3 py-1 text-sm font-medium text-primary"
        >
      ...
      {secondsLeft > 0 && !hideTimer && (
        <div className="text-center mt-4 mb-2 text-xs text-primary">
