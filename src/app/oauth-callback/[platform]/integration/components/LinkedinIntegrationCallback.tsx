...
import { LinkedInProfileType } from "@/types/account/profile.type";
...
export default function LinkedInIntegrationCallback() {
  ...
  useEffect(() => {
    ...
    const processCallback = async () => {
      try {
        ...
        console.log(
          "[LINKEDIN CALLBACK] Calling backend callback...",
        );

        const result =
          await apiClient.Integration.connectCallback<LinkedInProfileType>(
            PLATFORM,
            code,
            state,
          );
        ...
        console.log(
          "[LINKEDIN CALLBACK] Backend response:",
          result,
        );
        ...
        setTimeout(() => {
          if (
            ...
            window.location.href =
              "/onboarding?provider=linkedin&connected=true";
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="text-center">
        {status === "loading" && (
          <>
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#0A66C2] mx-auto mb-4" />
