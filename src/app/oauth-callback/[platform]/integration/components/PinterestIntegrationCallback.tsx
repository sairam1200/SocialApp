...
export default function PinterestIntegrationCallback() {
  ...
  useEffect(() => {
    ...
    async function processCallback() {
      ...
      const expiresIn =
        parseInt(result.expiresIn, 10) || DEFAULT_TOKEN_EXPIRY;
      ...
      setTimeout(() => {
        if (onboardingStep !== "Completed") {
          window.location.href =
            "/onboarding?provider=pinterest&connected=true";
          return;
        }
