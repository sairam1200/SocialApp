...
export default function GoodbyePage() {
	return (
		<div className="min-h-screen flex flex-col bg-white">
			{/* HEADER */}
			<header className="bg-white py-2 px-4 md:py-2 md:px-12 lg:py-4 lg:px-25 w-full flex items-center justify-center">
			...
			<div className="flex-1">
				<section className="flex flex-col bg-white text-[#0D0D0D] py-10 md:py-14 xl:pt-[131px] items-center">
