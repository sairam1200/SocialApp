...
const CustomizeGaddrDialog = ({ open, onClose }: DialogTypes) => {
				...
				<div>
					...
					>
						<div className="flex flex-col items-center justify-center">
							...
							<p className="text-sm font-medium">Drag the picture here</p>
							<p className="text-sm text-[#86909C]">Only png, jpg can be uploaded, and the size does not exceed 10MB</p>
						</div>
					</div>
				</div>
