...
import { TokenResponseType, TokenRequestType, RefreshTokenRequestType, LogoutRequestType, FacebookConnectResponseType, GoogleConnectResponseType, GoogleOAuthTokenResponseType, FacebookOAuthTokenResponseType, CurrentUserResponseType } from "@/types/auth/login.type";
...
async currentAsync(): Promise<CurrentUserResponseType> {
  ...
  @OnError([400, 401], async (error) => {
    console.log("Token refreshing error: ", error.response?.data)
